      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 md:py-32">
        <div className="text-center mb-16">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            {config.contactSectionSubheading}
          </motion.p>
        </div>
        ...
        >
          {/* WhatsApp Card */}
          {shouldShowContactMethod('whatsapp') && (
            <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-card/50 backdrop-blur-sm hover:bg-card/80">
              <CardContent className="p-8 text-center">
                ...
                <Button variant="secondary" size="sm" className="w-full" asChild>
                  <Link href={`https://wa.me/${config.whatsappNumber}`} target="_blank">
                    Start Chat
                  </Link>
                </Button>
              </CardContent>
          ...
          {shouldShowContactMethod('email') && (
            <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-card/50 backdrop-blur-sm hover:bg-card/80">
              <CardContent className="p-8 text-center">
                ...
                <Button variant="secondary" size="sm" className="w-full" asChild>
                  <Link href={`mailto:${config.emailAddress}`}>Send Email</Link>
                </Button>
              </CardContent>
            </Card>
          )}

          {/* Upwork Card - Always shown */}
          <Card className="group hover:shadow-lg transition-all duration-300 border-0 bg-card/50 backdrop-blur-sm hover:bg-card/80">
            <CardContent className="p-8 text-center">
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-gradient-to-r from-[--liftoff-blue] to-[--liftoff-orange] flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
